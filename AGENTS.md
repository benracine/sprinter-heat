...
**Method:** breadth then depth. See `.cursor/rules/tyrah-gift-book.mdc`.

1. **Breadth first** — part one readable end-to-end: consistent vocabulary, one loop story, honest status, no contradictions. Rebuild and skim.
