...
**House electrical (context only).** Hydronic 12 V from the **200 Ah** house battery (**650 W** solar; Sterling 60 A B2B; Mean Well RPB-1600-12). Isotemp 750 W from Paneltronics **WATER HEATER**, fed by shore or **PROwatt SW 2000** via a **Blue Sea 9009** rotary ([`photos/ac-electrical.jpg`](../photos/ac-electrical.jpg)). Mean Well charge path is a second **9009**. Ground-fault on Isotemp still OPEN ([Q-009](#q-009)).
