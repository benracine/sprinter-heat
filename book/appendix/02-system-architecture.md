...
**Planned locations (updated from SRC-004 “all under sink”):** heater + metering pump underbody (driver side / fuel-fill area — SRC-005). Duda B3-12DW-20 plate heat exchanger **under the sink** (as-built). Sure Marine cabin heater **under the fridge** (owner/Tyrah: fits). Isotemp Slim Square 4.2 gal heat battery **driver side under new sofa/bed** (current bed coming out; hybrid per [DEC-021](#dec-021); day geometry **outboard → seat back** / **inboard → seat butt**). Water Flow Tank (WFT) 5 L expansion/header in the **sofa-bed backrest (high)**; confirm top is highest circulating glycol point after framing. Cabin envelope already has **FatMat Rattle Trap** + Thinsulate-class insulation behind grey panels / L-track ([photo-extract-insulation](#photo-extract-insulation)). Owner priorities for sofa packaging: ease of access and ease of construction.
