...
**Planned locations (updated from SRC-004 “all under sink”):** heater + metering pump underbody (driver side / fuel-fill area — SRC-005). Duda B3-12DW-20 plate heat exchanger and Sure Marine cabin heater on van; intended near jump seat / sink-fridge (exact fit OPEN). Isotemp Slim Square 4.2 gal heat battery **driver side under new sofa/bed** (current bed coming out). Water Flow Tank (WFT) 5 L expansion/header at the **highest** circulating glycol point (exact mount OPEN—rear bench / high wall / other). Owner priorities for sofa packaging: ease of access and ease of construction.
