...
2. **Day sofa** — Night flat. Day intent: **outboard → seat back**, **inboard → seat butt** + aisle. Panel count / hardware OPEN. See [Working design understanding](#working-design-understanding) / [DEC-021](#dec-021).
...
| <span id="q-012">Q-012</span> | Exact heater mounting height vs Water Flow Tank and nearby lines? | Self-vent height; fuel-line clearance. | Owner / measurement | Partial | **Verify while mounting.** WFT → **sofa-bed backrest (high)**; Isotemp under bench (low). Confirm WFT top is highest glycol point after framing (DEC-005). |
