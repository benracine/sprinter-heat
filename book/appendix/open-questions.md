...
6. **House electrical snapshot** — Two transfer switches locked (panel source + Mean Well source). Still confirm Ah / solar / Mean Well model vs [SRC-040](#src-040) ([Q-025](#q-025)).
...
| <span id="q-009">Q-009</span> | Final Paneltronics breaker, GFCI/grounding, cable route, and element control? | 750 W ≈ 6.5 A at 115 V; never on empty chamber. | Owner / SRC-038 / SRC-040 / `photos/ac-electrical.jpg` | Yes (HOLD 9 only) | **2026-09-20 diagram:** Isotemp = AC panel “Coolant / water heater 120v.” Auto transfer feeds panel from shore or Xantrex. **No GFCI/ELCI drawn** on heater branch. Paneltronics face has no GFCI. HOLD 9 still needs intended ground-fault story + cable/first energize. |
...
| <span id="q-025">Q-025</span> | Does the installed house electrical still match [SRC-040](#src-040)? | Isotemp AC load planning; inverter vs shore behavior. | Owner / SRC-040 / SRC-041 | Partial (HOLD 9) | **2026-09-20:** Two transfer switches — (1) Paneltronics 120 V from **Xantrex PROwatt SW** or **120 V RV shore**; (2) **Mean Well** charger from **120 V RV shore** or **240 V J1772**. Confirm battery Ah, solar W, Mean Well model vs SRC-040. FarOutRide ([SRC-041](#src-041)) is reference class only. On-van faces: LinkPRO, PROwatt SW, Paneltronics 72313. |
