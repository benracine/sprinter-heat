...
|---|---|---|
| Locked loop, forbidden designs, part glossary | [System Design](#system-design) / [The Parts](#the-parts) | [System Architecture](#system-architecture) · [Decision Log](#decision-log) |
