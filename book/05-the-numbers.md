...
From the Hydronic D5S diesel heater manual ([SRC-009](#src-009)) unless noted. Swap the heater → rewrite this page from that manual first.
...
| Fluid in the heater itself | ~0.18 L (loop + Isotemp hold the rest) |
...
Isotemp chamber ~4.2 gal static glycol; coil charged by the heater pump; 750 W element on Paneltronics **WATER HEATER** (face **72313** / **9972313B**) for the chamber only ([DEC-004](#dec-004) / [DEC-007](#dec-007) / [DEC-020](#dec-020)).
